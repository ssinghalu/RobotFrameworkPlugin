...
public class RobotCaseResult extends RobotTestObject{
	...
	private int passTicketCount;
	private int failTicketCount;
	...
	public int getPassTicketCount() {
		return passTicketCount;
	}

	public int getFailTicketCount() {
	...
	public void addPassTicketCount(int count) {
		this.passTicketCount = count;
		
	}

	public void addFailTicketCount(int count) {
		this.failTicketCount = count;
