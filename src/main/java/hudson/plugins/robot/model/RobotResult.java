...
public class RobotResult extends RobotTestObject {
	...
	private transient int passed, failed, criticalPassed, criticalFailed, ticketsCount;
	...
	public long getCriticalPassed(){
		...
		return getAllPassedTicketCases();
	}
	...
	public long getCriticalFailed(){
		...
		return getAllFailedTicketCases();
	}
	...
	public long getCriticalTotal(){
		...
		return getOverallFailed() + getOverallPassed();
	}
	...
	public List<Ticket> getAllTickets() {
		...
		for(RobotSuiteResult suite : getSuites()){
			this.tickets.addAll(suite.getAllTickets());
		}
		return this.tickets;
	}
	...
	public int getAllFailedTicketCases(){
		int  allFailedCases = 0;
		for(RobotSuiteResult suite : getSuites()){
			int  failedCases = suite.getAllFailedTicketCases();
			allFailedCases =  allFailedCases + failedCases;
		}
		return allFailedCases;
	}

	public int getAllPassedTicketCases() {
		int  allPassedCases = 0;
		for(RobotSuiteResult suite : getSuites()){
			int  failedCases = suite.getAllPassedTicketCases();
			allPassedCases =  allPassedCases + failedCases;
		}
